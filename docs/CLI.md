...
The stable `0.2.4` package is already public and immutable; do not republish
...
The stable workflow is the published `0.2.4` build in this checkout. For
...
```bash
npm install -g ./swiveltechnologies-swico-0.2.4.tgz
```
