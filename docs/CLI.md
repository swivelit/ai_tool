...
The stable `0.2.5` package is already public and immutable; do not republish
...
The stable workflow is the published `0.2.5` build in this checkout. For
...
```bash
npm install -g ./swiveltechnologies-swico-0.2.5.tgz
```
