...
npm publish ./swiveltechnologies-swico-0.2.0-rc.5.tgz --access public --tag latest --registry=https://registry.npmjs.org/
```
...
```bash
npm install -g ./swiveltechnologies-swico-0.2.0-rc.5.tgz
```
