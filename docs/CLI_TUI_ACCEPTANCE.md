...
`0.2.0-rc.7` candidate. Installed controller/event coverage uses a disposable
...
`node-pty` ConPTY adapter and the RC7 helper emits a `[conpty-result]` sentinel
