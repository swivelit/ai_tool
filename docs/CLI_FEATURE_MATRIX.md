...
| npm package | IMPLEMENTED + VERIFIED (installed path) | `0.2.0-rc.2` candidate is tested locally against a controlled API/PTY; not published until owner approval |
