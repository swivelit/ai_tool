...
| npm package | IMPLEMENTED + VERIFIED (installed path) | `0.2.0-rc.5` candidate is tested locally against controlled API/PTY; Windows ConPTY and remote CI evidence are recorded separately; not published until owner approval |
