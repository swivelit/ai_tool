...
const modelDeliveryExtra = {
  ...
  LOCAL_MODEL_URL_GEMMA_4B: process.env.EXPO_PUBLIC_LOCAL_MODEL_URL_GEMMA_4B || "",
  LOCAL_MODEL_URL_QWEN_8B: process.env.EXPO_PUBLIC_LOCAL_MODEL_URL_QWEN_8B || "",
  LOCAL_MODEL_URL_QWEN_14B: process.env.EXPO_PUBLIC_LOCAL_MODEL_URL_QWEN_14B || "",
  LOCAL_MODEL_URL_QWEN_EMBED: process.env.EXPO_PUBLIC_LOCAL_MODEL_URL_QWEN_EMBED || "",

  // Integrity metadata. Production native_on_device builds fail clearly when
  // expected byte sizes or SHA-256 hashes are missing.
  LOCAL_MODEL_BYTES_GEMMA_4B: process.env.EXPO_PUBLIC_LOCAL_MODEL_BYTES_GEMMA_4B || "",
  LOCAL_MODEL_BYTES_QWEN_8B: process.env.EXPO_PUBLIC_LOCAL_MODEL_BYTES_QWEN_8B || "",
  LOCAL_MODEL_BYTES_QWEN_14B: process.env.EXPO_PUBLIC_LOCAL_MODEL_BYTES_QWEN_14B || "",
  LOCAL_MODEL_BYTES_QWEN_EMBED: process.env.EXPO_PUBLIC_LOCAL_MODEL_BYTES_QWEN_EMBED || "",
  LOCAL_MODEL_SHA256_GEMMA_4B: process.env.EXPO_PUBLIC_LOCAL_MODEL_SHA256_GEMMA_4B || "",
  LOCAL_MODEL_SHA256_QWEN_8B: process.env.EXPO_PUBLIC_LOCAL_MODEL_SHA256_QWEN_8B || "",
  LOCAL_MODEL_SHA256_QWEN_14B: process.env.EXPO_PUBLIC_LOCAL_MODEL_SHA256_QWEN_14B || "",
  LOCAL_MODEL_SHA256_QWEN_EMBED: process.env.EXPO_PUBLIC_LOCAL_MODEL_SHA256_QWEN_EMBED || "",
};
