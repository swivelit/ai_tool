...
const E2E_MOCK_API = process.env.EXPO_PUBLIC_E2E_MOCK_API || "";
const E2E_PLAY_FGS_MICROPHONE_DEMO =
  process.env.EXPO_PUBLIC_PLAY_FGS_MICROPHONE_DEMO || "";
...
const enabledE2eEnvNames = [
  ...
  ["EXPO_PUBLIC_E2E_MOCK_API", E2E_MOCK_API],
  [
    "EXPO_PUBLIC_PLAY_FGS_MICROPHONE_DEMO",
    E2E_PLAY_FGS_MICROPHONE_DEMO,
  ],
