...
const E2E_HANDS_FREE_WAKE_PHRASE =
  process.env.EXPO_PUBLIC_E2E_HANDS_FREE_WAKE_PHRASE || "";
const E2E_HANDS_FREE_COMMAND =
  process.env.EXPO_PUBLIC_E2E_HANDS_FREE_COMMAND || "";
...
const LOCAL_MODEL_URL_MINILM = process.env.EXPO_PUBLIC_LOCAL_MODEL_URL_MINILM || "";
...
const LOCAL_MODEL_BYTES_MINILM = process.env.EXPO_PUBLIC_LOCAL_MODEL_BYTES_MINILM || "";
...
const LOCAL_MODEL_SHA256_MINILM = process.env.EXPO_PUBLIC_LOCAL_MODEL_SHA256_MINILM || "";
...
const enabledE2eEnvNames = [
  ...
  ["EXPO_PUBLIC_E2E_HANDS_FREE_WAKE_PHRASE", E2E_HANDS_FREE_WAKE_PHRASE],
  ["EXPO_PUBLIC_E2E_HANDS_FREE_COMMAND", E2E_HANDS_FREE_COMMAND],
]
  .filter(([name, value]) =>
    name === "EXPO_PUBLIC_E2E_VOICE_QUERY" ||
    name === "EXPO_PUBLIC_E2E_VOICE_SURFACE" ||
    name === "EXPO_PUBLIC_E2E_HANDS_FREE_WAKE_PHRASE" ||
    name === "EXPO_PUBLIC_E2E_HANDS_FREE_COMMAND"
...
if (isProductionOrReleaseBuild && enabledE2eEnvNames.length) {
  throw new Error(
    `Release/production builds cannot enable debug E2E flags: ${enabledE2eEnvNames.join(
      ", ",
    )}. Disable mock auth/model setup/voice language bypass before building a release APK.`,
  );
}
...
if (isProductionNativeDownloadBuild) {
  if (LOCAL_MODEL_CDN_BASE_URL) {
    ...
    requireProductionResolvedUrl("EXPO_PUBLIC_LOCAL_MODEL_URL_MINILM or EXPO_PUBLIC_LOCAL_MODEL_CDN_BASE_URL", LOCAL_MODEL_URL_MINILM);
  }
}
...
requireProductionPositiveInteger("EXPO_PUBLIC_LOCAL_MODEL_BYTES_MINILM", LOCAL_MODEL_BYTES_MINILM);
...
requireProductionSha256("EXPO_PUBLIC_LOCAL_MODEL_SHA256_MINILM", LOCAL_MODEL_SHA256_MINILM);
...
const modelDeliveryExtra = {
  ...
  EXPO_PUBLIC_LOCAL_MODEL_URL_MINILM: LOCAL_MODEL_URL_MINILM,
  ...
  EXPO_PUBLIC_LOCAL_MODEL_BYTES_MINILM: LOCAL_MODEL_BYTES_MINILM,
  ...
  EXPO_PUBLIC_LOCAL_MODEL_SHA256_MINILM: LOCAL_MODEL_SHA256_MINILM,
};
...
export default {
  expo: {
    ...
    extra: {
      ...
      E2E_HANDS_FREE_WAKE_PHRASE,
      E2E_HANDS_FREE_COMMAND,
      EXPO_PUBLIC_E2E_MOCK_AUTH: E2E_MOCK_AUTH,
      EXPO_PUBLIC_E2E_SKIP_MODEL_SETUP: E2E_SKIP_MODEL_SETUP,
      EXPO_PUBLIC_E2E_MOCK_VOICE_TURN: E2E_MOCK_VOICE_TURN,
      EXPO_PUBLIC_E2E_MOCK_HANDS_FREE: E2E_MOCK_HANDS_FREE,
      ...
      LOCAL_MODEL_MINILM:
        process.env.EXPO_PUBLIC_LOCAL_MODEL_MINILM ||
