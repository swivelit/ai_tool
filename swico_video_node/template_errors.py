...
ACTIONS = {
    ...
    "template_tracks_unknown": "Use one of the two imported template IDs: couple-01 or couple-02.",
    "template_tracks_missing": "Prepare the imported template before correcting its local face tracks.",
    "template_tracks_invalid": "The local track record is malformed; restore a reviewed copy and prepare again.",
    "template_tracks_overlap": "A frame assigns the same target role to more than one face; reassign or exclude the ambiguous track.",
    "template_track_unknown": "Choose a track ID shown by templates tracks status.",
    "template_track_role_invalid": "Choose male, female or exclude for the track.",
    "template_track_split_invalid": "Choose a frame inside the track range where the identity changes or re-enters.",
    "template_track_operation_invalid": "Use reassign, exclude or split for a reviewed local track correction.",
    ...
    "provenance_response_invalid": "The fixed upstream response was not a bounded algorithm-labelled technical sidecar (CRC32 or SHA-256); no model bytes were downloaded.",
    "provenance_redirect_invalid": "The fixed technical sidecar redirected outside the pinned HTTPS GitHub release hosts; no model bytes were downloaded.",
    "provenance_redirect_limit": "The fixed technical sidecar exceeded the bounded redirect limit; no model bytes were downloaded.",
    "provenance_sha256_invalid": "Supply the independently reviewed full-model SHA-256 as exactly 64 hexadecimal characters.",
    "provenance_sha256_conflict": "The proposed technical SHA-256 differs from an existing recorded value; stop and review the pinned asset evidence.",
    "provenance_sha256_invalid": "Provide one exact 64-hex SHA-256 or a local regular model file with the explicit review metadata; no model is installed.",
    "model_expected_hash_missing": "Record an independently reviewed full-model SHA-256 with models provenance record --sha256; a legacy CRC32 sidecar does not satisfy the install gate.",
