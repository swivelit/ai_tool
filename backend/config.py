...
OPENAI_API_MODE = _env_str("OPENAI_API_MODE", "auto")
OPENAI_MODEL_CHEAP_PRIMARY = _env_str("OPENAI_MODEL_CHEAP_PRIMARY", "gpt-5-nano")
OPENAI_MODEL_CHEAP_FALLBACKS = _env_str("OPENAI_MODEL_CHEAP_FALLBACKS", "gpt-4.1-nano,gpt-4o-mini")
OPENAI_MODEL_REASONING_LIGHT_PRIMARY = _env_str("OPENAI_MODEL_REASONING_LIGHT_PRIMARY", "gpt-4.1-mini")
OPENAI_MODEL_REASONING_PRIMARY = _env_str("OPENAI_MODEL_REASONING_PRIMARY", "gpt-5-mini")
OPENAI_MODEL_REASONING_FALLBACKS = _env_str("OPENAI_MODEL_REASONING_FALLBACKS", "gpt-4.1-mini,gpt-4o-mini")
OPENAI_MODEL_HARD_REASONING = _env_str("OPENAI_MODEL_HARD_REASONING", "o4-mini")
OPENAI_ENABLE_O_SERIES_FOR_FREE = _env_bool("OPENAI_ENABLE_O_SERIES_FOR_FREE", False)
OPENAI_ENABLE_GPT35_EMERGENCY_FALLBACK = _env_bool("OPENAI_ENABLE_GPT35_EMERGENCY_FALLBACK", False)
OPENAI_DISABLED_MODELS = _env_str("OPENAI_DISABLED_MODELS", "")
OPENAI_MODEL_PROBE_CACHE_TTL_SECONDS = _env_int("OPENAI_MODEL_PROBE_CACHE_TTL_SECONDS", 900, minimum=1)
...
SARVAM_CHAT_MODEL = _env_str("SARVAM_CHAT_MODEL", "sarvam-105b")
...
SARVAM_TTS_SPEAKER_EN = _env_str("SARVAM_TTS_SPEAKER_EN", "anushka")
SARVAM_TTS_SPEAKER_TA = _env_str("SARVAM_TTS_SPEAKER_TA", "karun")
SARVAM_TTS_PACE_EN = _env_str("SARVAM_TTS_PACE_EN", "0.95")
SARVAM_TTS_PACE_TA = _env_str("SARVAM_TTS_PACE_TA", "0.9")

VOICE_ONLY_PUBLIC_MODE = _env_bool("VOICE_ONLY_PUBLIC_MODE", True)
AI_TEXT_CHAT_ENABLED = _env_bool("AI_TEXT_CHAT_ENABLED", False)
DEFAULT_SPEECH_LANGUAGE = _env_str("DEFAULT_SPEECH_LANGUAGE", "ta-IN")
DEFAULT_REPLY_LANGUAGE = _env_str("DEFAULT_REPLY_LANGUAGE", "ta")

AI_ROUTER_ENABLED = _env_bool("AI_ROUTER_ENABLED", True)
AI_ROUTER_GLOBAL_CACHE_LOOKUP_ENABLED = _env_bool("AI_ROUTER_GLOBAL_CACHE_LOOKUP_ENABLED", True)
AI_ROUTER_GLOBAL_CACHE_RECORD_ENABLED = _env_bool("AI_ROUTER_GLOBAL_CACHE_RECORD_ENABLED", True)
...
AI_DEFAULT_ANSWER_STYLE = _env_str("AI_DEFAULT_ANSWER_STYLE", "mobile_concise")
AI_DEFAULT_MAX_BULLETS = _env_int("AI_DEFAULT_MAX_BULLETS", 5, minimum=1)
AI_DEFAULT_MAX_PARAGRAPHS = _env_int("AI_DEFAULT_MAX_PARAGRAPHS", 3, minimum=1)
AI_DETAILED_ANSWER_TRIGGERS = _env_str(
...
ENABLE_ADMIN_AI_PROBE = _env_bool("ENABLE_ADMIN_AI_PROBE", False)
AI_EMBEDDINGS_ON_EVERY_TURN = _env_bool("AI_EMBEDDINGS_ON_EVERY_TURN", False)
AI_MAX_EMBEDDING_CALLS_PER_TURN = _env_int("AI_MAX_EMBEDDING_CALLS_PER_TURN", 1, minimum=0)
AI_SEMANTIC_CACHE_LOOKUP_ENABLED = _env_bool("AI_SEMANTIC_CACHE_LOOKUP_ENABLED", True)
AI_SEMANTIC_CACHE_LOOKUP_FOR_SIMPLE_CHAT = _env_bool("AI_SEMANTIC_CACHE_LOOKUP_FOR_SIMPLE_CHAT", False)
AI_RAG_LOOKUP_FOR_SIMPLE_CHAT = _env_bool("AI_RAG_LOOKUP_FOR_SIMPLE_CHAT", False)
AI_EMBED_POST_RESPONSE_ASYNC = _env_bool("AI_EMBED_POST_RESPONSE_ASYNC", False)
AI_EMBED_POST_RESPONSE_BATCH = _env_bool("AI_EMBED_POST_RESPONSE_BATCH", True)
USER_QA_SYNC_MIN_HITS = _env_int("USER_QA_SYNC_MIN_HITS", 2, minimum=1)
USER_QA_SYNC_TTL_DAYS = _env_int("USER_QA_SYNC_TTL_DAYS", 30, minimum=1)
