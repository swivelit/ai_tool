...
SARVAM_MAX_RETRIES = _env_int("SARVAM_MAX_RETRIES", 3, minimum=1)
SARVAM_TIMEOUT = _env_int("SARVAM_TIMEOUT", 30, minimum=5)
SARVAM_RETRY_DELAY = _env_float("SARVAM_RETRY_DELAY", 1.0, minimum=0.1)
