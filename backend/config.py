...
OPENAI_MODEL_REASONING = _env_str("OPENAI_MODEL_REASONING", OPENAI_MODEL_STANDARD)
OPENAI_MODEL_HIGH = _env_str("OPENAI_MODEL_HIGH", "")
OPENAI_DISABLE_HIGHEST_MODEL = _env_bool("OPENAI_DISABLE_HIGHEST_MODEL", True)
OPENAI_DAILY_BUDGET_USD = _env_float("OPENAI_DAILY_BUDGET_USD", 0.0, minimum=0.0)
OPENAI_MAX_OUTPUT_TOKENS_DEFAULT = _env_int("OPENAI_MAX_OUTPUT_TOKENS_DEFAULT", 900, minimum=1)
OPENAI_MAX_OUTPUT_TOKENS_HARD = _env_int("OPENAI_MAX_OUTPUT_TOKENS_HARD", 1600, minimum=1)
