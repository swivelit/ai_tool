...
FAST_RAG_STRONG_MATCH_THRESHOLD = _env_float("FAST_RAG_STRONG_MATCH_THRESHOLD", 0.96, minimum=0.0)
FAST_RAG_PREFIX_MATCH_THRESHOLD = _env_float("FAST_RAG_PREFIX_MATCH_THRESHOLD", 0.98, minimum=0.0)
FAST_RAG_CACHE_MATCH_THRESHOLD = _env_float("FAST_RAG_CACHE_MATCH_THRESHOLD", 0.96, minimum=0.0)
FAST_RAG_MAX_CACHE_ROWS = _env_int("FAST_RAG_MAX_CACHE_ROWS", 40, minimum=1)
...
THENI_TAMIL_MODE = _env_str("THENI_TAMIL_MODE", "api_then_local").lower() or "api_then_local"
THENI_TAMIL_API_URL = _env_str("THENI_TAMIL_API_URL", "http://127.0.0.1:9001/convert")
