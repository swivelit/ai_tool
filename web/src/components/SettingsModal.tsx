      ...
      <div className="settings-layout">
        ...
        <div className="settings-content">
          ...
          {loaded && section === 'usage' && <section aria-labelledby="usage-settings"><h3 id="usage-settings">Token credits</h3>
            <div className="usage-cards"><article><span>{loaded.usage.tier_label} balance</span><strong>{estimatedTokenLabel(estimate?.estimated_blended_tokens)}</strong></article><article><span>Estimated range</span><strong>{tokenRange}</strong></article></div>
