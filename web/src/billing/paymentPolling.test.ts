...
it('polls pending payment until credited without creating another order', async () => {
  const payment = { internal_order_id:'o1', gross_amount_paise:1000, credited_amount_micros:5_000_000, platform_share_paise:500, refunded_amount_paise:0, provider_payment_id:'p1', created_at:'', paid_at:null, refunded_at:null, updated_at:'' }
