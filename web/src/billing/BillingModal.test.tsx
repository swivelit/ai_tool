...
it('shows gross payment, credited value, and does not load checkout when order creation fails', async () => {
  ...
  expect(document.querySelector('.allocation')).toHaveTextContent('Converted to token credits 50%')
  expect(document.querySelector('.allocation')).toHaveTextContent('Service and platform allocation 50%')
